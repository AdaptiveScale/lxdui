...
lxdui.auth.conf = {{app_root}}/conf/auth.conf
lxdui.ssl.cert = {{app_root}}/conf/client.crt
lxdui.ssl.key = {{app_root}}/conf/client.key
lxdui.log.conf = {{app_root}}/conf/log.conf
#lxdui.log.rotate = true
#lxdui.log.max = 10M
#lxdui.log.keep.generations = 5
lxdui.profiles = {{app_root}}/conf/profiles
